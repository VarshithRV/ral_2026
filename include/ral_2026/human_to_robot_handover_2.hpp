...
class Handover
{
    ...
    private:
        ...
        Eigen::Vector3d object_to_grasp_position_transform = Eigen::Vector3d(0.04,-0.065,-0.03);
        ...
        bool set_io_sync(rclcpp::Client<ur_msgs::srv::SetIO>::SharedPtr client,int8_t pin,float state);
};
